...
class ConfigurationDialog(QtWidgets.QDialog):
    """This class creates a dialog to manage the application configuration
       allowing access and modify it
    """
    ...
    def setupUi(self,configuration=None):
        ...
        self.acceptButton.setText("Guardar")
    ...
    def getConfiguration(self):
        ...
        configuration.userName = self.userEdit.text()
        configuration.host = self.hostEdit.text()
        configuration.passWord = self.passwordEdit.text()
    ...
    def setConfiguration(self, configuration):
        if configuration is not None:
            ...
            self.userEdit.setText(configuration.userName)
            self.hostEdit.setText(configuration.host)
            self.passwordEdit.setText(configuration.passWord)
